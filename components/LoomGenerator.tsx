          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            <div className="text-left">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 ml-12">
                    Create a personalized landing page in seconds.
                </p>
            </div>
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">
                            <span className="w-full h-px bg-gray-100 dark:bg-dark-700"></span>
                            <span>Identity</span>
                            <span className="w-full h-px bg-gray-100 dark:bg-dark-700"></span>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-50 dark:bg-dark-900 border border-gray-200 dark:border-dark-700 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all"
                                />
                            </div>
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-gray-500 dark:text-gray-400 flex items-center gap-1.5">
                                    <Building2 className="w-3.5 h-3.5" /> Sender Name / Company
                                </label>
                                <input
                                    type="text"
                                    value={senderName}
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <div className="h-[42px] w-full bg-gray-50 dark:bg-dark-900 border border-gray-200 dark:border-dark-700 rounded-lg p-1 flex items-center gap-2 cursor-pointer relative overflow-hidden group">
                                    <div 
                                        className="w-8 h-8 rounded border border-black/10 shadow-sm"
                                        style={{ backgroundColor: themeColor }}
                                    ></div>
                                    <span className="text-xs font-mono text-gray-600 dark:text-gray-400 uppercase">{themeColor}</span>
                                    <input
                                        type="color"
                                        value={themeColor}
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="flex bg-gray-50 dark:bg-dark-900 border border-gray-200 dark:border-dark-700 rounded-lg p-1 h-[42px]">
                                    <button 
                                        onClick={() => setPreviewTheme('light')} 
                                        className={`flex-1 rounded-md flex items-center justify-center gap-1.5 text-xs font-bold transition-all ${previewTheme === 'light' ? 'bg-white shadow-sm text-gray-900' : 'text-gray-400 hover:text-gray-600'}`}
                                    >
                                        <Sun className="w-3.5 h-3.5" />
                                    </button>
                                    <button 
                                        onClick={() => setPreviewTheme('dark')} 
                                        className={`flex-1 rounded-md flex items-center justify-center gap-1.5 text-xs font-bold transition-all ${previewTheme === 'dark' ? 'bg-dark-700 shadow-sm text-white' : 'text-gray-400 hover:text-gray-200'}`}
                                    >
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-gray-500 dark:text-gray-400 flex items-center gap-1.5">
                                    <Video className="w-3.5 h-3.5" /> Loom Link
                                </label>
                                <input
                                    type="text"
                                    value={loomUrl}
                                    ...
                                    className="w-full bg-gray-50 dark:bg-dark-900 border border-gray-200 dark:border-dark-700 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all placeholder:text-gray-300 dark:placeholder:text-dark-600"
                                />
                            </div>
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-gray-500 dark:text-gray-400 flex items-center gap-1.5">
                                    <Calendar className="w-3.5 h-3.5" /> Booking Link
                                </label>
                                <input
                                    type="text"
                                    value={bookingLink}
                    ...
                    <div className="border-t border-gray-100 dark:border-dark-700 pt-4">
                        <details className="group">
                            <summary className="flex items-center justify-between cursor-pointer p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-dark-900/50 transition-colors">
                                <span className="flex items-center gap-2 text-xs font-bold text-gray-600 dark:text-gray-300">
                                    <Settings className="w-3.5 h-3.5" /> Advanced Customization
                                </span>
                                <ChevronDown className="w-3.5 h-3.5 text-gray-400 group-open:rotate-180 transition-transform" />
                            </summary>
                            
                            <div className="mt-4 space-y-4 pl-2 border-l-2 border-gray-100 dark:border-dark-700 ml-2">
                                <div className="space-y-1">
                                    <label className="text-[10px] font-bold uppercase text-gray-400">Badge Text</label>
                                    <input type="text" value={badgeText} onChange={e => setBadgeText(e.target.value)} className="w-full bg-transparent border-b border-gray-200 dark:border-dark-700 py-1 text-xs focus:border-brand-500 outline-none transition-colors" />
                                </div>
                                <div className="space-y-1">
                                    <label className="text-[10px] font-bold uppercase text-gray-400">Headline</label>
                                    <input type="text" value={headline} onChange={e => setHeadline(e.target.value)} className="w-full bg-transparent border-b border-gray-200 dark:border-dark-700 py-1 text-xs focus:border-brand-500 outline-none transition-colors" />
                                </div>
                                <div className="space-y-1">
                                    <label className="text-[10px] font-bold uppercase text-gray-400">Description</label>
                                    <textarea rows={2} value={description} onChange={e => setDescription(e.target.value)} className="w-full bg-transparent border-b border-gray-200 dark:border-dark-700 py-1 text-xs focus:border-brand-500 outline-none transition-colors resize-none" />
                                </div>
                                <div className="space-y-1">
                                    <label className="text-[10px] font-bold uppercase text-gray-400">Highlights Title</label>
                                    <input type="text" value={highlightsTitle} onChange={e => setHighlightsTitle(e.target.value)} className="w-full bg-transparent border-b border-gray-200 dark:border-dark-700 py-1 text-xs focus:border-brand-500 outline-none transition-colors" />
                                </div>
                                <div className="space-y-1">
                                    <label className="text-[10px] font-bold uppercase text-gray-400">Highlights (One per line)</label>
                                    <textarea rows={3} value={highlights} onChange={e => setHighlights(e.target.value)} className="w-full bg-transparent border-b border-gray-200 dark:border-dark-700 py-1 text-xs focus:border-brand-500 outline-none transition-colors resize-none" />
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        <label className="text-[10px] font-bold uppercase text-gray-400">CTA Title</label>
                                        <input type="text" value={ctaTitle} onChange={e => setCtaTitle(e.target.value)} className="w-full bg-transparent border-b border-gray-200 dark:border-dark-700 py-1 text-xs focus:border-brand-500 outline-none transition-colors" />
                                    </div>
                                    <div className="space-y-1">
                                        <label className="text-[10px] font-bold uppercase text-gray-400">Button Text</label>
                                        <input type="text" value={ctaBtn} onChange={e => setCtaBtn(e.target.value)} className="w-full bg-transparent border-b border-gray-200 dark:border-dark-700 py-1 text-xs focus:border-brand-500 outline-none transition-colors" />
                                    </div>
                                </div>
                                <div className="space-y-1">
                                    <label className="text-[10px] font-bold uppercase text-gray-400">CTA Description</label>
                                    <textarea rows={2} value={ctaDesc} onChange={e => setCtaDesc(e.target.value)} className="w-full bg-transparent border-b border-gray-200 dark:border-dark-700 py-1 text-xs focus:border-brand-500 outline-none transition-colors resize-none" />
                                </div>
                            </div>
                        </details>
                    </div>
                    ...
                    <div className="space-y-4 pt-2">
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-brand-600 hover:bg-brand-500 text-white font-bold rounded-xl transition-all shadow-[0_4px_14px_0_rgba(34,197,94,0.39)] hover:shadow-[0_6px_20px_rgba(34,197,94,0.23)] hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2"
                        >
                    ...
                    {/* Result */}
                    {generatedLink && (
                        <div id="generated-result" className="pt-6 border-t border-gray-100 dark:border-dark-700 animate-fade-in">
                            <div className="bg-brand-50 dark:bg-brand-900/10 border border-brand-200 dark:border-brand-500/20 rounded-xl p-4 space-y-3">
                                <div className="flex items-center justify-between">
                                    <span className="text-xs font-bold text-brand-700 dark:text-brand-400 uppercase tracking-wider flex items-center gap-2">
                                        <Link className="w-3.5 h-3.5" /> Ready to share
                                    </span>
                                    <span className="w-2 h-2 rounded-full bg-brand-500 animate-pulse"></span>
                                </div>
                                <div className="bg-white dark:bg-dark-900 border border-gray-200 dark:border-dark-700 rounded-lg p-2 text-xs font-mono text-gray-500 break-all select-all">
                                    {generatedLink}
                                </div>
                                <div className="flex gap-2">
                                    <button
                                        onClick={copyToClipboard}
                                        className="flex-1 py-2.5 bg-white dark:bg-dark-800 border border-gray-200 dark:border-dark-700 hover:border-brand-500 text-gray-700 dark:text-white font-bold rounded-lg transition-all flex items-center justify-center gap-2 text-xs shadow-sm"
                                    >
