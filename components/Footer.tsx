  ...
  return (
    <footer className="bg-black border-t border-dark-800 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-8">
          <div className="max-w-md text-center md:text-left">
             <div className="flex items-center justify-center md:justify-start gap-2 mb-4">
                <Waypoints className="w-6 h-6 text-brand-500 fill-brand-500/20" />
        ...
        <div className="border-t border-dark-800 pt-8 flex justify-center md:justify-start">
            <p className="text-xs text-dark-600">© 2024 CrocodeFlow AI. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
