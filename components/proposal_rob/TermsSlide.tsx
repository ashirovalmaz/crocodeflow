    ...
    return (
        <div className="space-y-8 animate-fade-in max-w-6xl mx-auto">
            <p className="text-center text-gray-600 max-w-3xl mx-auto">
                Выберите объем внедрения. Стоимость обновляется автоматически в зависимости от систем, которые вы включаете в дорожную карту.
            </p>
            ...
            <div className="bg-gray-50 rounded-xl border border-gray-200 p-6">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-bold text-gray-700">Настройка дорожной карты</h3>
                    <span className="text-xs text-gray-500 ml-auto font-medium">При выборе 2+ систем применяется <span className="text-brand-600 font-bold">скидка на внедрение</span></span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
                ...
                <div className="bg-white p-8 rounded-2xl border border-gray-200 flex flex-col shadow-sm">
                    <h3 className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">Вариант 1</h3>
                    <h4 className="text-xl font-bold text-gray-900 mb-6">Стандартное сотрудничество</h4>
                    
                    <div className="flex items-baseline gap-2 mb-4">
                        <div className="text-4xl font-display font-bold text-brand-600">
                            ${finalSetup.toLocaleString()}
                        </div>
                        <span className="text-lg font-normal text-gray-500">внедрение</span>
                    </div>
                        ...
                        <div className="mb-6 animate-slide-up">
                            <div className="inline-flex flex-col gap-1 px-4 py-2.5 rounded-xl bg-brand-600 text-white shadow-xl shadow-brand-500/20 border border-brand-400">
                                <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest">
                                    <Zap className="w-3 h-3 fill-white" /> Скидка за пакет применена
                                </div>
                                <div className="text-lg font-bold">Экономия ${discountAmount.toLocaleString()}</div>
                            </div>
                        </div>
                    )}

                    <div className="text-xl text-gray-600 mb-8">+ ${totalMonthly.toLocaleString()} / месяц</div>
                ...
                <div className="bg-gradient-to-br from-brand-900 to-emerald-950 p-8 rounded-2xl border border-brand-500/50 shadow-2xl relative overflow-hidden flex flex-col">
                    ...
                    <h3 className="text-xs font-bold uppercase tracking-wider text-brand-400 mb-2">Вариант 2</h3>
                    <h4 className="text-xl font-bold text-white mb-6">Годовой контракт</h4>
                    
                    <div className="flex items-baseline gap-2 mb-2">
                        <div className="text-4xl font-display font-bold text-white">
                            ${annualPrice.toLocaleString()}
                        </div>
                        <span className="text-lg font-normal text-gray-400">единоразово</span>
                    </div>
                    <div className="text-sm text-brand-400 font-bold mb-8 uppercase tracking-wide flex items-center gap-2">
                        <TrendingDown className="w-4 h-4" /> Экономия ~45% уже включена
                    </div>
                    ...
                    <div className="space-y-4 mb-8 flex-grow">
                        ...
                        <div className="flex justify-between items-center text-sm bg-brand-500/20 p-3 rounded-xl border border-brand-500/30">
                            <span className="text-brand-300 font-bold uppercase text-[10px] tracking-widest">Итоговая выгода</span>
                    ...
                    <p className="text-[10px] text-brand-400/80 text-center font-bold uppercase tracking-widest">
                        Разовая оплата. Без ежемесячных платежей на 12 месяцев.
                    </p>
                </div>
            </div>
        </div>
