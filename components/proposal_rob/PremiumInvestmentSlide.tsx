...
export const PremiumInvestmentSlide: React.FC = () => {
    ...
    // Annual price is typically a ~45% discount on the total 12-month value (Setup + 12*Monthly)
        ...
        <div className="space-y-10 animate-fade-in max-w-6xl mx-auto">
            ...
            <div className="text-center space-y-4">
                <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed">
                    Scaling to the next level requires shifting from founder-led DMs to a structured, automated acquisition engine. Choose your starting implementation package below.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
                ...
                <div className="bg-white p-10 rounded-3xl border border-gray-200 shadow-sm flex flex-col relative overflow-hidden">
                    ...
                    <div className="mb-10">
                        ...
                        <h3 className="text-2xl font-display font-bold text-gray-900">Standard Engagement</h3>
                    ...
                    <div className="space-y-6 mb-10">
                        ...
                        <div className="text-2xl text-gray-700 font-medium">+ ${totalMonthly.toLocaleString()} / month</div>
                    </div>

                    <div className="flex-grow space-y-4 border-t border-gray-100 pt-8 mb-8">
                        <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Included Systems:</p>
                    ...
                    <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                        ...
                        <span className="text-xs text-gray-600 font-bold uppercase tracking-wider">30-Day Implementation Guarantee</span>
                    </div>
                </div>

                {/* Annual Plan (Premium) */}
                <div className="bg-gray-900 p-10 rounded-3xl border border-brand-500/50 shadow-2xl flex flex-col relative overflow-hidden transform lg:-translate-y-4">
                    ...
                    <div className="space-y-4">
                         ...
                         <p className="text-[10px] text-gray-500 text-center uppercase tracking-widest font-bold">Priority Implementation Included</p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 pt-10 border-t border-gray-100">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-xs font-bold text-gray-900 uppercase">Revenue Focused</p>
                        <p className="text-[10px] text-gray-500">Every system built to print money</p>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                    <div className="p-2 bg-brand-50 rounded-lg text-brand-600">
                    ...
                    <div>
                        <p className="text-xs font-bold text-gray-900 uppercase">Fast Deployment</p>
                        <p className="text-[10px] text-gray-500">Live in as little as 14 days</p>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                    <div className="p-2 bg-brand-50 rounded-lg text-brand-600">
                    ...
                    <div>
                        <p className="text-xs font-bold text-gray-900 uppercase">Scalable Tech</p>
                        <p className="text-[10px] text-gray-500">Built to handle 10x your volume</p>
                    </div>
                </div>
            </div>
        </div>
